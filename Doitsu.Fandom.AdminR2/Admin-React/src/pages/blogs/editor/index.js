...
class BlogEditor extends React.Component {
        ...
        this.setState(
          {
            ...
            defaultEditorState: blogStateObject.content,
          },
          () => {
            // set to form
  ...
  handleFormSubmit = () => {
    const { thumbnailURL, editorState } = this.state
    ...
    form.validateFieldsAndScroll(async (err, values) => {
      if (!err) {
        ...
        const createModel = { ...values, thumbnailURL, content: editorState, active: true }
  ...
  render() {
    ...
    const { spinning, defaultFileUpload, defaultEditorState, blogCategoryOptions } = this.state
    return (
                ...
                <div className="form-group">
                  <FormItem label="Content">
                    {form.getFieldDecorator('content')(
                      <EditorWysiwygCTHTML
                        name="content"
                        defaultHtml={defaultEditorState}
