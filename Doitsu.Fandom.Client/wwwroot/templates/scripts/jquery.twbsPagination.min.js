...
var framework_y_initPagination = function (i) {
    var a;
    i.fn.initTwbsPagination = function () {
        ...
        var s = i(this).attr("data-options"),
            n = i(this).attr("data-pagination-anima"),
            e = parseInt(i(this).attr("data-page-items"), 10),
            o = i(this).closest(".grid-list"),
            l = i(o).find(".grid-box .grid-item"),
            r = i(l).length,
            d = "pagination";
        ...
        if ("pagination" == d) {
            var m, p = {
                ...
                visiblePages: 7,
                first: "<i class='fa fa-angle-double-left'></i> <span>Đầu</span>",
                last: "<span>Cuối</span> <i class='fa fa-angle-double-right'></i>",
                next: "<span>Tiếp theo</span> <i class='fa fa-angle-right'></i>",
                prev: " <i class='fa fa-angle-left'></i> <span>Trở về</span>",
    ...
    var execute = function () {
        ...
        i(".album-item").hide(), i("body").on("click", ".album-box", function () {
            var s = i(this).closest(".album-main"),
                n = i(s).attr("data-album-anima"),
            ...
            var a = i(this).closest(".album-main"),
                s = i(a).attr("data-album-anima"),
                n = i(a).find(".album-list");
